...
public class User {
    ...
    private static final String PREFERENCES_FILE_NAME = "com.example.vidas.uzdpaskirstymas";
    ...
    public User(int userlevel, String username, String password, String fullName, String email) {
    ...
    public User(int id, int userlevel, String username, String password, String fullName, String email) {
        this.id = id;
        this.userlevel = userlevel;
        this.username = username;
        this.password = password;
    ...
    public String getFullNameForRegister() {
        return fullName;
    }
